...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__layouts_admin_admin_layout_component__ = __webpack_require__("../../../../../src/app/layouts/admin/admin-layout.component.ts");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var DatacenterComponent = (function () {
    function DatacenterComponent(modalService, config, route, AmCharts, router, dynamicSubMenu) {
        var _this = this;
        ...
        this.router = router;
        this.dynamicSubMenu = dynamicSubMenu;
            ...
            if (typeof _this.dataCenterId !== "undefined") {
                setTimeout(function () {
                    _this.config.getComponentList(_this.dataCenterId).subscribe(function (res_comp) {
                        ...
                        for (var i = 0; i < _this.dynamicSubMenu.dynamicSubMenu.length; i++) {
                            if (_this.dynamicSubMenu.dynamicSubMenu[i].id == _this.dataCenterId) {
                                _this.dataCenterHeading = _this.dynamicSubMenu.dynamicSubMenu[i].name;
                                break;
                            }
                        }
                        _this.subComponents = [];
    ...
    DatacenterComponent.prototype.scrollRightClick = function () {
        var nextClick = this.selectedComponentViewId + 1;
        if (nextClick >= this.components.length) {
            nextClick = 0;
        }
        this.componnetScrollClick(nextClick);
    };
    DatacenterComponent.prototype.scrollLeftClick = function () {
        var nextClick = this.selectedComponentViewId - 1;
        if (nextClick < 0) {
