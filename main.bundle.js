...
var AdminLayoutComponent = (function () {
    ...
    AdminLayoutComponent.prototype.reloadCurrentPage = function (id) {
        ...
        if (id === void 0) { id = ''; }
        setTimeout(function () {
            if (_this.cookieService.get('currentUrl') == _this.router.url) {
                if (id != '') {
