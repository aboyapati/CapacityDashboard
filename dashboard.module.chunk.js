...
var DashboardComponent = (function () {
    ...
    DashboardComponent.prototype.ngOnInit = function () {
        ...
        __WEBPACK_IMPORTED_MODULE_3_rxjs_Rx__["Observable"].interval(15000 * 60).subscribe(function (x) {
            _this.config.getDashboardData()
                .subscribe(function (res) {
                var dataset = [];
                for (var data in res) {
    ...
    DashboardComponent.prototype.getNotificationWithFilter = function (type) {
        var _this = this;
    ...
    DashboardComponent.prototype.redirectReport = function () {
