...
var ProvisioningComponent = (function () {
    ...
    ProvisioningComponent.prototype.openComponentModalNew = function (content, id, type, currentdatacenter, editFromView) {
        ...
        this.modalService.open(content, { windowClass: this.modalClassName, size: 'lg', backdrop: 'static' }).result.then(function (result) {
            _this.closeResult = "Closed with: " + result;
        }, function (reason) {
            _this.closeResult = "Dismissed " + _this.getDismissReason(reason);
        });
    ...
    ProvisioningComponent.prototype.validateEditComponent = function (e) {
        ...
        if (flag != true) {
            ...
            if (editComponentVersion_1 == 'Sub Type') {
                editComponentVersion_1 = '';
            }
            setTimeout(function () {
