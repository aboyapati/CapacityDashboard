...
var ProvisioningComponent = (function () {
    ...
    ProvisioningComponent.prototype.next = function (event) {
        var next_step = true;
        if (next_step) {
            var fieldSet = event.currentTarget.parentElement.parentElement.parentElement.parentElement.parentElement.parentElement;
            $(fieldSet).fadeOut(400, function () { });
    ...
    ProvisioningComponent.prototype.validateEditComponent = function (e) {
        ...
        if (flag != true) {
            ...
            setTimeout(function () {
                _this.config.editComponent('1', editComponentName_1, editComponentNameType_1, editComponentVersion_1, editComponentIpAddress_1, editComponentComponentUser_1, editComponentPassword_1, editComponentvrfWarnStart_1, editComponentvrfWarnEnd_1, editComponentvrfMax_1, editComponentbgpPeersWarnStart_1, editComponentbgpPeersWarnEnd_1, editComponentbgpPeersMax_1, editComponentvlanWarnStart_1, editComponentvlanWarnEnd_1, editComponentvlanMax_1, editComponenthsrpWarnStart_1, editComponenthsrpWarnEnd_1, editComponenthsrpMax_1, editComponentstaticRoutesWarnStart_1, editComponentstaticRoutesWarnEnd_1, editComponentstaticRoutesMax_1).subscribe(function (res) {
                    console.log(res);
                    $('.modalForm').hide();
                    $('.apiResponseDiv').show();
                    if (res.status == 'success') {
                        $('#editComponentDropdown' + _this.currentRow).hide();
                        _this.componentRecords.name = editComponentName_1;
                        _this.componentRecords.version = editComponentNameType_1;
                        _this.componentRecords.subVersion = editComponentVersion_1;
                        _this.componentRecords.ipAddress = editComponentIpAddress_1;
                        $('.apiFailed').hide();
                        $('.apiSuccess').show();
                    }
                    else {
    ...
    ProvisioningComponent.prototype.provisioningList = function () {
        var _this = this;
        setTimeout(function () {
            _this.config.getProvisioningList().subscribe(function (res) {
                ...
                _this.currentDC = _this.dataCenters[0]['id'];
            });
        }, 100);
    };
    // moveRight() {
    ...
    ProvisioningComponent.prototype.deleteComponentData = function (id) {
