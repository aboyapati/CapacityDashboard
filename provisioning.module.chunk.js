...
var ProvisioningComponent = (function () {
    ...
    ProvisioningComponent.prototype.open = function (content, id, type) {
        ...
        if (type == 'delete' || type == 'edit') {
            ...
            if (type == 'edit') {
                this.config.getStates(this.editData.country).subscribe(function (res) {
                    _this.statesList = res;
                });
                this.config.getCities(this.editData.state).subscribe(function (res) {
