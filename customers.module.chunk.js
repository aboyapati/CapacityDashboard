...
var CustomersComponent = (function () {
    ...
    CustomersComponent.prototype.getCustomers = function () {
        ...
        this.customerList = [];
        var val = '';
        this.config.getCustomersList().subscribe(function (res) {
