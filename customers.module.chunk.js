...
var CustomersComponent = (function () {
    ...
    CustomersComponent.prototype.getCustomers = function () {
        ...
        setTimeout(function () {
            var val = '';
            _this.config.getCustomersList(val).subscribe(function (res) {
                if (res.length < 1) {
                    _this.emptyCustomerFlag = true;
                }
    ...
    CustomersComponent.prototype.valuechange = function (e) {
        ...
        this.config.getCustomersList(val).subscribe(function (res) {
            if (res.length < 1) {
                _this.emptySearchCustomerFlag = true;
            }
            else {
                _this.emptySearchCustomerFlag = false;
            }
            _this.customerList = res;
        });
    };
