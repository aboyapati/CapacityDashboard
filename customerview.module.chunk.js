...
var CustomerviewComponent = (function () {
    ...
    CustomerviewComponent.prototype.ComponentClick = function (id) {
        var _this = this;
        this.config.getSubComponetCusView(id).subscribe(function (res) {
            _this.subCompTabItems = res;
            _this.selectedSubComp = _this.subCompTabItems[0].id;
        ...
        this.config.getCustomerContentCusView(this.selectedComp).subscribe(function (res) {
    ...
    CustomerviewComponent.prototype.subCompTabClick = function (id, name) {
        var _this = this;
        this.config.getCustomerContentCusView(id).subscribe(function (res) {
            _this.customerContent = res;
        });
