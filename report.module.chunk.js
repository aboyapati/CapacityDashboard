...
var ReportComponent = (function () {
    ...
    ReportComponent.prototype.downloadReport = function (reportId) {
        var _this = this;
        this.config.getDownloadReport(this.currentDC, this.fromDate, this.toDate, reportId).subscribe(function (res) {
            if (!$.isEmptyObject(res)) {
                _this.downloadData = res;
                _this.excelService.exportAsExcelFile(_this.downloadData, "Data Center Reports");
            }
            else {
